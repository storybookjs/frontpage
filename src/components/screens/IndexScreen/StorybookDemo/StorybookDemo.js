...
import { motion, MotionConfig, useTransform, useWillChange } from 'framer-motion';
...
export const StorybookDemo = ({ isolationScrollProgress, activeStory, ...props }) => {
