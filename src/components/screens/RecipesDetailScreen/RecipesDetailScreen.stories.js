...
export const Button = ({ label, ...rest }: ButtonProps) =&gt; (
  &lt;MuiButton {...rest}&gt;{label}&lt;/MuiButton&gt;
);</code></pre><p>And now our Button will only take the variant, size, and color props from <code>MuiButton</code>.</p><figure class="kg-card kg-image-card"><img src="https://lh3.googleusercontent.com/lqYwmkGTpx1aiKkPILYcsPs5WChsgI8PLO45Dba6LXk1GeKsTJhy_5F7BWIydAOinZ9nyxOeFB9OjUE3T_lEc1jFFAPpymN4SdMa2TIe0Cu9aASmPEtO6JbGrdpzfHisTgeaeVHNVdqYzjmKZl_VxsBEBqKTsg0bMn9p-oRKqbcdu_5jOhyuBSNuYA" class="kg-image" alt="The button story with only the controls specified" loading="lazy" width="679" height="640"></figure><p>📣 Shout out to <a href="https://twitter.com/ejmudrak">Eric Mudrak’s</a> awesome <a href="https://www.erikmudrak.com/post/storybook-with-react-typescript">Storybook with React &amp; TypeScript</a> article that inspired this tip.</p><h2 id="wrapping-up">Wrapping up</h2><p>Material UI has a lot to offer—a wide array of components, a powerful theming engine and an icon system. Instead of reinventing the wheel, you can use these building blocks to get going quickly. With a few configuration tweaks, your Storybook can unlock the full potential of Material UI.</p><p>Custom Material UI themes can be provided using a Storybook decorator and with an added toolbar item, you can toggle between multiple themes. This makes it easy to switch themes and verify the look and feel of the UI while building the app. Additionally, reuse Material UIs Typescript types to generate dynamic controls and documentation for your stories for free.</p><p>If you’re looking for a code example of what I covered here, check out my <a href="https://github.com/ShaunLloyd/storybook-mui-example"><code>storybook-mui-example</code></a> repo on GitHub. If you’re looking for a Storybook addon to handle themes for you, check out the <a href="https://storybook.js.org/addons/@react-theming/storybook-addon/">React Theming Addon</a> by awesome community members, <a href="https://www.npmjs.com/~usulpro">Usulpro</a> and <a href="https://www.npmjs.com/~smartlight">Smartlight</a>.<br></p>`;
